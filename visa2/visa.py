...
def main(driver, driver2, cracker):
    ...
    if np.random.rand() <= prob and cnt < 4:
        ...
        # os.system('python notify.py --type F &')
    ...
    #     os.system('python notify.py --type O &')
    ...
    #     os.system('python notify.py --type L &')
    driver.quit()
    driver2.quit()
